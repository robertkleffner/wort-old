...
module.exports = {
    ...
    parseRequire: function() {
        ...
        this.next();
        return { path: path.value, alias: alias, line: path.line, column: path.column };
    },
    ...
    parseDefinition: function() {
        ...
        terms.line = colon.line;
        terms.column = colon.column;
        ...
        return { name: name.value, terms: terms, line: name.line, public: name.value[0] !== '-', column: name.column };
    },
    ...
    parseTerms: function(quotLevel) {
        ...
        if (quotLevel > 0) {
            throw this.error('Unterminated quotation, add a right bracket', terms.line);
        }
