...
module.exports = {
    ...
    lexInlineJs: function() {
        ...
        this.next(3);
        var start = this.i, line = this.line, sc = this.column;
        ...
        var tok = this.token(this.types.INLINE_JS, this.input.substring(start, this.i), sc, line);
    ...
    lexObjectLiteral: function() {
        ...
        if (nest != 0) {
            ...
            return this.token(this.types.OBJECT, this.input.substring(start, this.i), sc, line);
        }
    },
    ...
    lexStackShuffle: function() {
        ...
        var tok = this.token(this.types.SHUFFLE, this.input.substring(start, this.i), sc);
        this.next();
        return tok;
    },
    ...
    lexObjectModifier: function() {
        ...
        return this.token(this.types.PROPERTY, this.input.substring(start, this.i), sc);
    },
    ...
    lexString: function() {
        ...
        this.next();
        return this.token(this.types.STRING, this.input.substring(start, this.i), sc, line);
    },

    lexNumber: function() {
        var start = this.i, sc = this.column;
        this.next();
        while (!this.eof() && this.validNumber(this.current())) {
            this.next();
        }
        return this.token(this.types.NUMBER, this.input.substring(start, this.i), sc);
    },

    lexSymbol: function() {
        this.next();
        return this.token(this.types.SYMBOL, this.input.substring(this.i-1, this.i), this.column-1);
    },

    lexOperator: function() {
        var longest = '', sc = this.column;
        ...
        if (longest == '') {
            ...
            this.next(longest.length);
            return this.token(this.types.OPERATOR, longest, sc);
        }
    },
    ...
    lexIdentifier: function() {
        ...
        return this.token(this.types.WORD, this.input.substring(start, this.i), sc);
    },
    ...
    token: function(type, val, column, line) {
        return {type: type, value: val || '', line: line || this.line, column: column };
    },
