...
module.exports = {
    ...
    lexInlineJs: function() {
        ...
        this.next(3);
        var start = this.i, line = this.line;
        ...
        var tok = this.token(this.types.INLINE_JS, this.input.substring(start, this.i), start, line);
    ...
    lexObjectLiteral: function() {
        ...
        if (nest != 0) {
            ...
            return this.token(this.types.OBJECT, this.input.substring(start, this.i), start, line);
        }
    },
    ...
    lexStackShuffle: function() {
        ...
        var tok = this.token(this.types.SHUFFLE, this.input.substring(start, this.i), start);
        this.next();
        return tok;
    },
    ...
    lexObjectModifier: function() {
        ...
        return this.token(this.types.PROPERTY, this.input.substring(start, this.i), start);
    },
    ...
    lexString: function() {
        ...
        this.next();
        return this.token(this.types.STRING, this.input.substring(start, this.i), line, start);
    },
    ...
    lexNumber: function() {
        ...
        return this.token(this.types.NUMBER, this.input.substring(start, this.i), start);
    },

    lexSymbol: function() {
        this.next();
        return this.token(this.types.SYMBOL, this.input.substring(this.i-1, this.i), this.i-1);
    },
    ...
    lexOperator: function() {
        ...
        if (longest == '') {
            ...
            return this.token(this.types.OPERATOR, longest, this.i - longest.length);
        }
    },
    ...
    lexIdentifier: function() {
        ...
        return this.token(this.types.WORD, this.input.substring(start, this.i), start);
    },
    ...
    token: function(type, val, column, line) {
        return {type: type, value: val || '', line: line || this.line, column: column || this.column};
    },
